...
from dfode_kit.runtime.config import resolve_runtime_config
...
def resolve_run_case_plan(args) -> dict[str, Any]:
    ...
    validate_run_case_runtime_config(runtime_config)
...
def validate_run_case_runtime_config(config: dict[str, Any]):
