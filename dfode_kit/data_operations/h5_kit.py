"""Compatibility shim for the canonical data I/O and integration modules."""
...
def __getattr__(name):
    if name not in _ATTRIBUTE_MODULES:
        raise AttributeError(f"module 'dfode_kit.data_operations.h5_kit' has no attribute '{name}'")
